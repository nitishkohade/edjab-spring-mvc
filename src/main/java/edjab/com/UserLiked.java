...
public class UserLiked {
	...
	@RequestMapping(value="/removeLikeService", method=RequestMethod.POST)
	public void getLikedByUser_POST(@RequestParam("key") String key, 
		...
		try {
			...
			webResource = client.getClient().resource(serviceurl.getUrl()+"/likeservice/delete/?likedby="+userid+"&likedTo="+key);
