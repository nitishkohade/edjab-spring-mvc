...
public class UserFollowed {
	...
	@RequestMapping(value="/removeFollowService", method=RequestMethod.POST)
	public void getFollowedByUser_POST(@RequestParam("key") String key, 
		...
		try {
			...
			webResource = client.getClient().resource(serviceurl.getUrl()+"/followservice/delete/?followedby="+userid+"&followedTo="+key);
