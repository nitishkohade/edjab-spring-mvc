...
public class UserToAttend {
	...
	@RequestMapping(value="/createUserToAttend", method=RequestMethod.POST)
	public void createUserToAttend_POST(@RequestParam("key") String key, 
		...
		try {
			...
			if(userid==null){
				...
				webResource = client.getClient().resource(serviceurl.getUrl()+"/attendservice/create/?attendedby="+userid+"&attendedTo="+key);
