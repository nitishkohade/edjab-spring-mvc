...
public class HelpfulReview {
	...
	@RequestMapping(value="/createHelpfulReview", method = RequestMethod.POST)
	public void createHelpfulReview_POST(@RequestParam("reviewid") String reviewid, 
		...
		try {
			...
			if(userid==null){
				...
				webResource = client.getClient().resource(serviceurl.getUrl()+"/usertoreviewservice/create/?userid="+userid+"&reviewid="+reviewid);
