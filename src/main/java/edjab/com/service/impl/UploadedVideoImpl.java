...
import edjab.com.service.UploadedVideo;
import edjab.com.service.url.ServiceURL;

@Component
public class UploadedVideoImpl implements UploadedVideo{
	...
	@Override
	public void getUploadedVideo(String uploadedTo, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		...
		try {												
			validateWebResource = client.getClient().resource(serviceurl.getUrl()+"/videoservice/schoolid/?uploadedTo="+uploadedTo);
