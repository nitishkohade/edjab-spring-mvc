...
import edjab.com.service.HeaderAutocomplete;
import edjab.com.service.url.ServiceURL;

@Component
public class HeaderAutocompleteImpl implements HeaderAutocomplete{
	...
	@Override
	public void getHeaderAutocomplete(String typedthings, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		...
		String result = null;		
				...
				try{						
			validateWebResource = client.getClient().resource(serviceurl.getUrl()+"/schoolprofileservice/prefix/?schoolNameId="+typedthings);
