...
import edjab.com.service.SchoolReviewId;
import edjab.com.service.url.ServiceURL;

@Component
public class SchoolReviewIdImpl implements SchoolReviewId{
	...
	@Override
	public void getReviewPerSchoolId(String reviewedTo, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		...
		try {												
			validateWebResource = client.getClient().resource(serviceurl.getUrl()+"/reviewservice/schoolid/?reviewedTo="+reviewedTo);
