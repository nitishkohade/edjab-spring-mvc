...
public class UpdatePassword {
	...
	public void getUpdatedPassword_Post(HttpServletResponse response, HttpServletRequest request, @RequestBody com.edjab.model.UpdatePassword updatePassword) throws IOException{
		...
		try {
			...
			String input = "{\"userId\":"+"\""+session.getAttribute("user_emailId")+"\""+",\"currentPassword\":"+"\""+updatePassword.getCurrentPassword()+"\""+",\"updatedPassword\":"+"\""+updatePassword.getUpdatedPassword()+"\""+"}";

			
			webResource = client.getClient().resource(serviceurl.getUrl()+"/userprofileservice/updatePassword/");
