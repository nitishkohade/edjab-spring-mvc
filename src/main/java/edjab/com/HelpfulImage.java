...
public class HelpfulImage {
	...
	@RequestMapping(value="/createHelpfulImage", method = RequestMethod.POST)
	public void createHelpfulImage_POST(@RequestParam("imageid") String imageid, @RequestParam("imageurl") String imageurl, 
		...
		try {
			...
			if(userid==null){
				...
				webResource = client.getClient().resource(serviceurl.getUrl()+"/usertoimageservice/create/?userid="+userid+"&imageid="+imageid+"&imageurl="+imageurl);
