...
public class UserToFollow {
	...
	@RequestMapping(value="/createUserToFollow", method=RequestMethod.POST)
	public void createUserToFollow_POST(@RequestParam("key") String key, 
		...
		try {
			...
			if(userid==null){
				...
				webResource = client.getClient().resource(serviceurl.getUrl()+"/followservice/create/?followedby="+userid+"&followedTo="+key);
