			...
			<div class="panel-body">
				<div class="tab-content">
					<div class="tab-pane fade in active">
					 ...
					 ng-show="noSchoolFollowed==true"><b>You haven't followed any University</b></p>
				
						<span ng-init="userFollowInit('${user_emailId}')"></span>	
				
							
				<div class="container col-lg-12 col-md-12 col-sm-12">
				<div 
				ng-repeat="s in followedSchools | limitTo:5 track by $index">
				
			    <div ng-click=clickFollowedSchool(s.key)
			    class="alert-success"
    			...
    			font-family: Times New Roman, Times, serif;">      
			       ...
			       <span style="float:right;background: dodgerblue;color:white;">
                		<button style="border: 0;" ng-click="removeFollow(s.key); $event.stopPropagation();" class="btn btn-success" aria-label="Remove">X</button>
            		</span>
