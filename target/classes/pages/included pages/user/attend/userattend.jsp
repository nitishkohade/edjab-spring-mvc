			...
			<div class="panel-body">
				<div class="tab-content">
					<div class="tab-pane fade in active">
					 ...
					 ng-show="noSchoolAttended==true"><b>You haven't attended any University</b></p>
				
						<span ng-init="userAttendInit('${user_emailId}')"></span>	
				
							
				<div class="container col-lg-12 col-md-12 col-sm-12">
				<div 
				ng-repeat="s in attendedSchools | limitTo:5 track by $index">
				
			    <div ng-click=clickAttendedSchool(s.key)
			    class="alert-success"
    			...
    			font-family: Times New Roman, Times, serif;">      
			       ...
			       <span style="float:right;background: dodgerblue;color:white;">
                		<button style="border: 0;" ng-click="removeAttend(s.key); $event.stopPropagation();" class="btn btn-success" aria-label="Remove">X</button>
            		</span>
